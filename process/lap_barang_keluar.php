...
<body>
    ...
    $nomor_surat = '005/INV-BK-P/DISDUKCAPIL/' . strtoupper(bulan_romawi(date('m'))) . '/' . date('Y');
    ...
    <div class="info-surat">
        <table style="border: none; width: 100%;">
            ...
            <tr>
                ...
                <td style="border: none;"><strong>Laporan Barang Keluar Periode</strong></td>
            </tr>
        </table>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="7" align="center" style="padding: 20px; color: #999;">
                        <em>Tidak ada data barang keluar pada periode ini</em>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
