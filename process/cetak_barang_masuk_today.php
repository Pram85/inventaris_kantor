...
<head>
    ...
    <title>Cetak Laporan Barang Masuk Hari Ini</title>
</head>
...
<body>
    ...
    $nomor_surat = '005/INV-BM-H/DISDUKCAPIL/' . strtoupper(bulan_romawi(date('m'))) . '/' . date('Y');
    ...
    <div class="info-surat">
        <table style="border: none; width: 100%;">
            ...
            <tr>
                ...
                <td style="border: none;"><strong>Laporan Barang Masuk Harian</strong></td>
            </tr>
        </table>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="7" align="center" style="padding: 20px; color: #999;">
                        <em>Tidak ada transaksi barang masuk hari ini</em>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
