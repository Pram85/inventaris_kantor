...
<body>
    ...
    $nomor_surat = '005/INV-BK/DISDUKCAPIL/' . strtoupper(bulan_romawi(date('m'))) . '/' . date('Y');
    ...
    <div class="info-surat">
        <table style="border: none; width: 100%;">
            ...
            <tr>
                ...
                <td style="border: none;"><strong>Laporan Barang Keluar</strong></td>
            </tr>
        </table>
    </div>
    ...
    <div class="judul-laporan">
        ...
        <span style="font-size: 12pt;">PERIODE: SEMUA DATA</span>
    </div>
