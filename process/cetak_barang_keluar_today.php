...
<head>
    ...
    <title>Cetak Laporan Barang Keluar Hari Ini</title>
</head>
...
<body>
    ...
    $nomor_surat = '005/INV-BK-H/DISDUKCAPIL/' . strtoupper(bulan_romawi(date('m'))) . '/' . date('Y');
    ...
    <div class="info-surat">
        <table style="border: none; width: 100%;">
            ...
            <tr>
                ...
                <td style="border: none;"><strong>Laporan Barang Keluar Harian</strong></td>
            </tr>
        </table>
    </div>
    ...
    <div class="judul-laporan">
        ...
        <span style="font-size: 12pt;">TANGGAL: <?= strtoupper($tanggal_cetak); ?></span>
    </div>
    ...
    <div style="page-break-after:always;">
        <table class="data">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="7" align="center" style="padding: 20px; color: #999;">
                        <em>Tidak ada transaksi barang keluar hari ini</em>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
            ...
            <tfoot>
                <tr>
                    <th colspan="6" style="text-align: right;">TOTAL BARANG KELUAR:</th>
